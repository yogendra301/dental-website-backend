...
--
-- Host: localhost:3306
-- Generation Time: Jul 17, 2026 at 08:19 AM
...
(19, 5, 'Aarav Mehta', '+919876543210', 'Root Canal', '2026-07-11', '10:00', 'completed', 'walkin', 'Severe pain in back molar.', 0, NULL, NULL, NULL, NULL, NULL, 0, 4500.00, 0.00, 4500.00, NULL, 'paid'),
(20, 5, 'Diya Sharma', '+919123456789', 'Teeth Cleaning', '2026-07-10', '11:30', 'completed', 'phone', 'Routine cleanup and scaling.', 0, NULL, NULL, NULL, NULL, NULL, 0, 1200.00, 0.00, 1200.00, NULL, 'paid'),
(21, 5, 'Rohan Kapoor', '+919555666777', 'Tooth Extraction', '2026-07-11', '14:00', 'completed', 'walkin', 'Broken tooth due to injury.', 1, NULL, NULL, NULL, NULL, NULL, 0, 2500.00, 0.00, 1500.00, NULL, 'partially_paid'),
(23, 1, 'vikas', '+919754640521', 'Tooth Pain & Checkup', '2026-07-17', '10:00', 'confirmed', 'phone', 'pain in wisdom tooth', 1, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0.00, 0.00, NULL, 'unpaid'),
(24, 1, 'jitendra sharma', '+919926719320', 'Root Canal Treatment (RCT)', '2026-07-17', '12:30', 'confirmed', 'phone', 'root canal', 0, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0.00, 0.00, NULL, 'unpaid');
...
CREATE TABLE `clinics` (
  ...
  `contact_map_url` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `admin_password_hash` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `admin_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slot_mode` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'fixed',
  ...
  `doctor_pin_hash` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reset_otp` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reset_otp_expires` datetime DEFAULT NULL,
  `google_review_link` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `whatsapp_phone_number_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reviews` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `package` int NOT NULL DEFAULT '3'
...
(17, 5, 'single', '/uploads/assets/clinic_003/gallery/1783062375-136b8916a4530d34.png', NULL, NULL, '', '2026-07-11 15:17:49'),
(18, 5, 'single', '/uploads/assets/clinic_003/gallery/1783062384-c4ccc340122f9229.jpg', NULL, NULL, '', '2026-07-11 15:17:49'),
(19, 5, 'single', '/uploads/assets/clinic_003/gallery/1783062392-d1c55fcd5f71b13b.jpeg', NULL, NULL, '', '2026-07-11 15:17:49'),
(20, 5, 'single', '/uploads/assets/clinic_003/gallery/1783062402-e70008fb5c4ff4eb.webp', NULL, NULL, '', '2026-07-11 15:17:49'),
(21, 5, 'single', '/uploads/assets/clinic_003/gallery/1783226940-906c7714e31f6514.png', NULL, NULL, 'reception', '2026-07-11 15:17:49'),
(22, 5, 'single', '/uploads/assets/clinic_003/gallery/1783226946-f27b80529ce3668f.png', NULL, NULL, 'treatment room', '2026-07-11 15:17:49');
...
INSERT INTO `patient_documents` (`id`, `clinic_id`, `patient_phone`, `appointment_id`, `file_name`, `file_path`, `file_type`, `uploaded_at`) VALUES
(2, 5, '+919876543210', NULL, 'prescription.png', '/api/documents/view/5/919876543210/1783745399-498466514c6447e8.png', 'image', '2026-07-11 04:49:59'),
(3, 5, '+919555666777', NULL, 'prescription.png', '/api/documents/view/5/919555666777/1783764087-2419a9e937e5bc88.png', 'image', '2026-07-11 10:01:27');
